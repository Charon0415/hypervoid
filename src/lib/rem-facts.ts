...
/**
 * Compact, plain-text site factsheet for Rem's system prompt.
 * Re-queried on every chat turn — same logic as kanna-facts.ts.
 */
export async function getRemSiteFacts(): Promise<string> {
  try {
