...
export function DailyPick({ post }: { post: PostMeta }) {
  ...
  return (
    <Link
      href={`/posts/${slug}`}
      className="group relative flex items-center gap-4 overflow-hidden border border-cyan-100/16 bg-gradient-to-r from-cyan-950/40 to-slate-950/60 p-3 transition hover:border-cyan-400/40 hover:shadow-[0_0_28px_rgba(103,232,249,0.15)] sm:p-4"
    ...
    >
      ...
      <div className="grid h-10 w-10 shrink-0 place-items-center border border-cyan-400/30 bg-cyan-950/60 text-cyan-300 transition group-hover:border-cyan-400/50 group-hover:bg-cyan-900/50 group-hover:text-cyan-200" style={{ clipPath: 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 0 100%)' }}>
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 flex min-w-0 items-center gap-1.5 text-sm font-semibold tracking-tight text-cyan-50 transition group-hover:text-cyan-100">
